...
public final class TFVarsLanguage extends DefaultLanguageConfig {
    ...
    private static final Language<TFVarsTokenId> language = new LanguageHierarchy<TFVarsTokenId>() {
            ...
            @Override
            protected Lexer<TFVarsTokenId> createLexer(LexerRestartInfo<TFVarsTokenId> info) {
                return  new TFVarsLexer(info);
            }

            @Override
            protected Collection<TFVarsTokenId> createTokenIds() {
                return EnumSet.allOf(TFVarsTokenId.class);
            }
