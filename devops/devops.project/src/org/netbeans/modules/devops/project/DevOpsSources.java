 ...
 * @author lkishalmi
 */
@ProjectServiceProvider(projectType = DevOpsProject.PROJECT_TYPE, service = Sources.class)
public class DevOpsSources implements Sources {
    
    private final Project project;

    public DevOpsSources(Project project) {
